...
#resourceArray = ["Organization","Patient","Observation","Medication","Encounter"]
#resourceArray = ["Patient"]
#resourceArray = ["Consent","Medication","Patient","Organization"]#Observation","Medication","Encounter"]

#resourceArray = ["Medication"]
resourceArray = ["Organization"]
columns_in_errors = {'Consent':['identifier.type.coding.id',
 ...
 'provision.provision.provision.provision.data.reference.display'],'Practitioner':['identifier.type.coding',
...
for resourceName in resourceArray:
    ...
    while page_url:
        ...
        if next_url == page_url:
            break  # Stop the loop if the next URL is the same as the current URL
        page_url = next_url
        pagenumber += 1
    ...
    #data_df = data_df.append(entries, ignore_index=True)
   ...
   #data_df = pd.DataFrame(data)  # Just for illustration, replace with your actual DataFrame
    ...
    for col in data_df.columns:
        ...
        # Assuming entries is a list of dictionaries
    
     # Append the entries to the data_df DataFrame
    #data_df = data_df.append(entries, ignore_index=True)
